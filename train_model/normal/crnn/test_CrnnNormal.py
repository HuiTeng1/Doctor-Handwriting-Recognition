...
RESULTS_DIR = os.path.join(SCRIPT_DIR, '..', '..', '..', 'data', 'normal', 'results')
os.makedirs(RESULTS_DIR, exist_ok=True)
TEST_RESULTS_PATH = os.path.join(RESULTS_DIR, 'crnn_test_results.csv')
...
def main():
    ...
    try:
        ...
        raise RuntimeError(f"Failed to load CRNN checkpoint at {best_ckpt_path}: {e}") from e
    train_module.eval()
