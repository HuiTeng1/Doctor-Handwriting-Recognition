...
# Iam_split.py (preprocessing/normal/, 1,915 rows) - the same data and val set used to train
...
RESULTS_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', '..', 'data', 'normal', 'results')
os.makedirs(RESULTS_DIR, exist_ok=True)
CSV_SAVE_PATH = os.path.join(RESULTS_DIR, "trocr_test_results.csv")
