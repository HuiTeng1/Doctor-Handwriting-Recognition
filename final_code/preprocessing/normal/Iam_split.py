...
CRNN_SPLITS_DIR = os.path.join(NORMAL_DATA_DIR, 'crnn')     # final_code/data/normal/crnn
TROCR_SPLITS_DIR = os.path.join(NORMAL_DATA_DIR, 'trocr')   # final_code/data/normal/trocr
