"""
Runs P0-P3 on the Train+Val images from ../data/doctor/doctor_clean/ (Test is untouched),
writing output to preprocessed_doctor/<pipeline>/. Reuses preprocessing/pipelines.py
rather than reimplementing the preprocessing logic.
"""
import os
import sys
...
OUTPUT_ROOT = os.path.join(_HERE, "..", "..", "data", "doctor", "preprocessed_doctor")
