...
# Dataset_prepare/Iam_split.py (1,915 rows) - the same data and val set used to train
...
MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'checkpoint', 'trocr')

CSV_SAVE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "test_results.csv")
