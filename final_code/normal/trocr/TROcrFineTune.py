...
Data source:
  train/val use the 95/5 split from load_trocr_splits() in Dataset_prepare/Iam_split.py -
...
STAGE1_OUTPUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'checkpoint', 'trocr')
...
# ----------------------------------------------------------------------
# Data prep - split/extraction logic lives in Dataset_prepare/Iam_split.py, shared with crnnNormal
# ----------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    # supports resuming from the latest checkpoint after a disconnect/interruption; set False for the first run
