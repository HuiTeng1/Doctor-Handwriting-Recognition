...
IAM_DATASET_DIR = os.path.join(SCRIPT_DIR, 'I_Am_Dataset')
...
CRNN_SPLITS_DIR = os.path.join(SCRIPT_DIR, 'crnn')     # final_code/dataset/crnn
TROCR_SPLITS_DIR = os.path.join(SCRIPT_DIR, 'trocr')   # final_code/dataset/trocr
