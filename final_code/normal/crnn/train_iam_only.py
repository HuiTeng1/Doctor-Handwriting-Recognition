...
CKPT_DIR = os.path.join(SCRIPT_DIR, '..', 'checkpoint', 'crnn')   # the trained checkpoint (with DONE.txt) lives here; the split source changed but the data content didn't, so this is unaffected
